...
<script src="<?php echo base_url('asset/libs/jsvectormap/dist/js/jsvectormap.min.js?1692870487') ?>" defer></script>
<script src="<?php echo base_url('asset/libs/jsvectormap/dist/maps/world.js?1692870487') ?>" defer></script>
<script src="<?php echo base_url('asset/libs/jsvectormap/dist/maps/world-merc.js?1692870487') ?>" defer></script>
