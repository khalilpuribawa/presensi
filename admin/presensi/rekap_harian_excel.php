...
$result = mysqli_query($connection,"SELECT presensi.*, siswa.nama, siswa.lokasi_presensi, siswa.nisn FROM presensi JOIN siswa ON presensi.id_siswa = siswa.id WHERE tanggal_masuk BETWEEN '$tanggal_dari' AND '$tanggal_sampai'  ORDER BY tanggal_masuk DESC");
