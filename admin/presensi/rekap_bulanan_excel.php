...
$filter_tahun_bulan = $_POST['filter_tahun_2'] . '-'. $_POST['filter_bulan'];
$result = mysqli_query($connection,"SELECT presensi.*, siswa.nama, siswa.lokasi_presensi, siswa.nisn FROM presensi JOIN siswa ON presensi.id_siswa = siswa.id WHERE DATE_FORMAT(tanggal_masuk, '%Y-%m') = '$filter_tahun_bulan' ORDER BY tanggal_masuk DESC");
...
$sheet->setCellValue('C3', $_POST['filter_tahun_2']);
