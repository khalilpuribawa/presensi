...
if(empty($_GET['tanggal_dari'])) {
    ...
    $result = mysqli_query($connection,"SELECT presensi.*, siswa.nama, siswa.lokasi_presensi FROM presensi JOIN siswa ON presensi.id_siswa = siswa.id WHERE tanggal_masuk = '$tanggal_hari_ini' ORDER BY tanggal_masuk DESC");
}else{
    $tanggal_dari = $_GET['tanggal_dari'];
    $tanggal_sampai = $_GET['tanggal_sampai'];
    $result = mysqli_query($connection,"SELECT presensi.*, siswa.nama, siswa.lokasi_presensi FROM presensi JOIN siswa ON presensi.id_siswa = siswa.id WHERE tanggal_masuk BETWEEN '$tanggal_dari' AND '$tanggal_sampai'  ORDER BY tanggal_masuk DESC");
}
